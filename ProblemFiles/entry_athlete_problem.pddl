...
;action Fartlek
;as mostly based in aerobic system executed mainly in 1-4 week
...
;This represents entry level athlete who intent to get into shape

(=(strength upper_limbs) 25)
(=(strength lower_limbs) 25)
(=(strength mid_body) 25) 


(=(endurance upper_limbs) 20)
(=(endurance lower_limbs) 25) 
(=(endurance mid_body) 20)

(=(explosiveness upper_limbs) 15)
(=(explosiveness lower_limbs) 15) 
(=(explosiveness mid_body) 20) 
...
(:goal
(and 
 (>= (strength lower_limbs) 30) 
 (>= (strength upper_limbs) 30)
 (>=(strength mid_body) 30) 

 (>=(endurance upper_limbs) 35)
 (>=(endurance lower_limbs) 35) 
 (>=(endurance mid_body) 35)

 (>=(explosiveness upper_limbs) 20)
 (>=(explosiveness lower_limbs) 20) 
 (>=(explosiveness mid_body) 25)
