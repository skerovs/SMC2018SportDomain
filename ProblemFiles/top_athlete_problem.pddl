...
(define (problem athlete1-general-period)  
(:objects
...
;this action is mostly used for competition period and is usually conected with technique and tactic training 
...
;this method includes exercies such as:
(=(action_capacity anaerobic w1) 0)   ;maybe three?
...
;strenghtEndurance is also mostlytrained in first weeks 
...
;This represents an athlete with top level performance

(=(strength upper_limbs) 60)
(=(strength lower_limbs) 62)
(=(strength mid_body) 65) 


(=(endurance upper_limbs) 65)
(=(endurance lower_limbs) 70) 
(=(endurance mid_body) 65)

(=(explosiveness upper_limbs) 75)
(=(explosiveness lower_limbs) 75) 
(=(explosiveness mid_body) 65)   
...
(:goal
(and 
 (>= (strength lower_limbs) 65) 
 (>= (strength upper_limbs) 65)
 (>=(strength mid_body) 70) 

 (>=(endurance upper_limbs) 75)
 (>=(endurance lower_limbs) 75) 
 (>=(endurance mid_body) 75)

 (>=(explosiveness upper_limbs) 80)
 (>=(explosiveness lower_limbs) 80) 
 (>=(explosiveness mid_body) 70)    
